...
export const SHOP_ITEMS: ShopItem[] = [
  { id: 'apple', name: 'Энерго-яблоко', price: 2, type: 'food', minLevel: 1, description: 'Простое лакомство. Настроение +8.', imageUrl: '/assets/items/treats/energy_apple.png', effect: { mood: 8 } },
  { id: 'cookie', name: 'Хрустик', price: 3, type: 'food', minLevel: 1, description: 'Хрустящее лакомство. Настроение +10.', imageUrl: '/assets/items/treats/crunchik.png', effect: { mood: 10 } },
  { id: 'berry', name: 'Сияющая ягодка', price: 5, type: 'food', minLevel: 2, description: 'Любимая ягодка питомцев. Настроение +15.', imageUrl: '/assets/items/treats/glowing_berry.png', effect: { mood: 15 } },
  { id: 'icecream', name: 'Ледяной десерт', price: 7, type: 'food', minLevel: 3, description: 'Праздничное лакомство. Настроение +20.', imageUrl: '/assets/items/treats/ice_dessert.png', effect: { mood: 20 } },
  { id: 'star_treat', name: 'Звёздный кристалл', price: 10, type: 'food', minLevel: 5, description: 'Редкое лакомство. Настроение +25.', imageUrl: '/assets/items/treats/star_crystal.png', effect: { mood: 25 } },
