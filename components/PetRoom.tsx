...
import { getActiveWorld, getEarnedStickers, getFulfilledRequestedTreat, getRequestedTreat, hasActiveDailyWorld, markRequestedTreatFulfilled, STREAK_STICKERS } from '../services/premiumFeatureCatalog';
...
export const PetRoom: React.FC<Props> = ({ userProfile, onUseItem, onBuy, onClose, onOpenShop }) => {
  ...
  const use = async (id: string) => {
    ...
    if (currentItem?.type === 'food') {
      ...
      setSpeech(`Ой, как вкусно! Спасибо за «${currentItem.name}». Мне стало веселее!`);
    } else {
