...
const steps = ['Ребёнок', 'PIN взрослого', 'Питомец'];
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm font-bold leading-6 text-slate-600">
              Сначала добавим ребёнка и защитим кабинет родителя PIN-кодом. После этого ребёнок сможет назвать питомца и начать играть.
            </p>
          </div>
        ...
        <form onSubmit={submit} className="mt-7 grid gap-5" noValidate>
          <div className="grid gap-4 lg:grid-cols-[0.85fr_1.15fr]">
            ...
            <section className="rounded-[1.75rem] border-2 border-purple-50 bg-purple-50/60 p-4 sm:p-5">
              <div className="text-xs font-black uppercase tracking-widest text-purple-400">2. Доступ взрослого</div>
              <p className="mt-3 text-sm font-bold leading-relaxed text-gray-600">PIN нужен, чтобы ребёнок случайно не попал в кабинет родителя на этом устройстве.</p>
              ...
              <div id="pin-help" className="mt-4 rounded-2xl bg-white px-4 py-3 text-xs font-bold leading-5 text-purple-900">
                На новом устройстве потребуется обычный вход в аккаунт. PIN не заменяет пароль.
              </div>
            </section>
          </div>
