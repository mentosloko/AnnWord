...
const MODE_RULES = {
  ...
  memory: [
    ...
    'Победа в Памяти приносит больше опыта: чем лучше результат, тем больше награда.',
    'Игра тренирует узнавание слова и перевод, а не только скорость.',
  ],
  hangman: [
    'Угадывайте слово по буквам до окончания попыток.',
    'Победа приносит больше опыта, но завершённая попытка тоже даёт немного опыта.',
