...
export const PracticeHomeScreen: React.FC<Props> = ({ userProfile, dailyQuest, hasActiveClassicGame, hasActiveAnagramGame, activeDictionaryName, activeDictionaryWordCount, onStartDailyQuest, onStartClassic, onStartAnagrams, onStartTranslation, onStartSprint, onStartHangman, onStartMemory, onOpenProfile, onOpenDictionaryStudio, onOpenPremium }) => {
  ...
  const cards: GameCard[] = [
    ...
    { title: '1 из 2', subtitle: 'Выбрать перевод', description: 'Посмотрите русское слово и выберите правильный английский вариант из двух похожих карточек.', imageSrc: '/assets/games/game_one_of_two.webp', badge: 'новая', accent: 'bg-pink-500', onStart: onStartTranslation },
    { title: 'Спринт', subtitle: 'Быстро проверить себя', description: 'Короткая тренировка на скорость: удобно закрыть практику за 1–2 минуты.', imageSrc: '/assets/games/game_sprint.webp', badge: questBadge('sprint', 'быстро'), accent: 'bg-green-500', onStart: onStartSprint },
