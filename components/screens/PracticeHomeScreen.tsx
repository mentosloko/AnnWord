...
const getReviewEntries = (wordsToReview?: Record<string, number>): Array<[string, number]> => Object.entries(wordsToReview || {}).map(([word, priority]) => [word, Number(priority) || 0]).sort(([, a], [, b]) => b - a).slice(0, 12);
