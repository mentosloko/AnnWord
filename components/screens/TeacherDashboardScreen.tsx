...
const t = { title: 'Обзор преподавателя', subtitle: 'Рабочий режим без игр, питомцев и монет. Основные разделы: ученики, словари и сводка преподавателя.', students: 'Ученики', dictionaries: 'Словари', summary: 'Сводка', code: 'Подключение учеников, прогресс, сложные слова и назначение словарей.', vocab: 'Создавайте подборки слов и назначайте их подключённым ученикам.', progress: 'Общие показатели учеников и управление данными аккаунта преподавателя.', connect: 'Подключить ученика', connectHelp: 'Родитель формирует код в кабинете родителя. Введите его здесь — ученик появится в разделе «Ученики».', placeholder: 'Код ребёнка', openStudents: 'Открыть учеников' };
