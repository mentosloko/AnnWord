...
export interface ActiveWordSource { source: DictionarySource; difficulty: DifficultyLevel; premiumDictionaryId?: string; spotlightGrade?: number; spotlightSectionId?: string; }
