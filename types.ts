...
export type ViewState = 'landing' | 'profile' | 'setup' | 'game' | 'review' | 'anagrams' | 'translation' | 'sprint' | 'hangman' | 'memory' | 'shop' | 'pet_room' | 'account_mode_setup' | 'character_onboarding' | 'family_setup' | 'admin' | 'adult_room' | 'dictionary_settings' | 'dictionary_studio' | 'premium';
