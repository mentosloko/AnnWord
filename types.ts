...
export interface ActiveWordSource { source: DictionarySource; difficulty: DifficultyLevel; premiumDictionaryId?: string; spotlightGrade?: number; spotlightSectionId?: string; updatedAt?: string; }
...
export interface GameSettings { wordLength: WordLength; useCustomDictionary: boolean; dictionarySource: DictionarySource; difficulty: DifficultyLevel; username: string; activePremiumDictionaryId?: string; activeSpotlightGrade?: number; activeSpotlightSectionId?: string; activeWordSourceUpdatedAt?: string; }
