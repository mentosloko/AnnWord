...
export async function applyYandexMigrations(): Promise<void> {
  if (migrationPromise) {
    return migrationPromise;
  }

  migrationPromise = applyYandexMigrationsOnce();
  return migrationPromise;
}

async function applyYandexMigrationsOnce(): Promise<void> {
